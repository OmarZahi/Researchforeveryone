...
export const detailItems = [
  { label: "Duration", value: "10 weeks (studio + remote)" },
  { label: "Studio days", value: "Wednesday & Saturday" },
...
export const programTracks = [
  {
    ...
    requirements: [
      ...
      "Upload tidy lab notes after every studio block"
    ],
    modules: [
  ...
  },
  {
    ...
    modules: [
      ...
      { week: "Weeks 3-6", title: "Sensor studio", summary: "Build and calibrate sensing nodes or wearables.", takeaways: ["Firmware loops", "Data calibration"] },
...
export const admissionsSteps = [
  ...
  { step: "2", title: "Mini brief", desc: "Join a 60-minute studio exercise with other applicants." },
...
export const aidOptions = [
  { title: "Need-based scholarships", info: "Covers up to 80% of tuition for public-school students." },
...
export const projects = [
  { season: "Winter 2025", title: "Sun-powered cooling mesh", desc: "Biology and materials team made a canopy that cools courtyards.", tags: "Materials • Climate" },
  { season: "Summer 2024", title: "Open health patch", desc: "Wearable that tracks hydration with off-the-shelf parts.", tags: "Health Tech" },
  { season: "Winter 2024", title: "Canal water lab", desc: "Low-cost testing kit now shared with three governorates.", tags: "Environmental" }
];

export const alumni = [
  { name: "Merna Safwat", quote: "I published my first preprint and joined a Cairo research group." },
  { name: "Kareem Hammad", quote: "Our AI-for-biology project started here and is now a startup pilot." }
];

export const staff = [
  { name: "Ahmad Saeed", role: "Program Director", expertise: "Mechatronics", link: "#" },
  { name: "Lamiaa Nail", role: "Learning Designer", expertise: "Maker Education", link: "#" },
  { name: "Sherif Rashwan", role: "Lead Instructor", expertise: "Electronics", link: "#" },
  { name: "Sara Adel", role: "Wet Lab Mentor", expertise: "Biology", link: "#" },
  { name: "Placeholder Mentor", role: "Field Research Lead", expertise: "Environmental", link: "#" }
];

export const patentHighlights = [
  { title: "Clinical SunPatch", desc: "Lightweight UV patch designed with dermatology clinics.", status: "Filed" },
  { title: "Smart Air Brick", desc: "Ventilation module co-built with fellows and makerspaces.", status: "Drafting" }
];

export const partnerLogos = ["Future Sponsor", "Open Lab", "Civic Tech", "Placeholder Labs"];

export const mapMarkers = [
  { name: "Cairo Studio", x: 62, y: 40 },
  { name: "Alexandria Pop-up", x: 35, y: 25 },
  { name: "Mansoura Lab", x: 58, y: 28 },
  { name: "Upper Egypt Site", x: 55, y: 70 }
];
